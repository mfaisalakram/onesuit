  ...
  t.fn.vectorMap = function (t) {
    ...
    if ('addMap' === t) jvm.Map.maps[arguments[1]] = arguments[2];
      ...
      if (('set' === t || 'get' === t) && e[t][arguments[1]])
        ...
        ].apply(a, Array.prototype.slice.call(arguments, 2));
  ...
  (function (t) {
    ...
    function o(s) {
      ...
      if (
        ...
        'deltaX' in r && ((c = r.deltaX), 0 === p && (o = -1 * c)),
        0 !== p || 0 !== c)
      ) {
        if (1 === r.deltaMode) {
        ...
        return (
          ...
          (!a || i < a) && ((a = i), m(r, i) && (a /= 40)),
          m(r, i) && ((o /= 40), (c /= 40), (p /= 40)),
          (o = Math[o >= 1 ? 'floor' : 'ceil'](o / a)),
...
(jvm.$ = jQuery),
    ...
    try {
      document.namespaces.rvml ||
        ...
        (jvm.VMLElement.prototype.createElement = function (t) {
          return document.createElement('<rvml:' + t + ' className="rvml">');
        });
    } catch (t) {
      jvm.VMLElement.prototype.createElement = function (t) {
        return document.createElement(
          '<' + t + ' xmlns="urn:schemas-microsoft.com:vml" className="rvml">'
        );
      };
    }
  ...
  (jvm.Proj = {
    ...
    lcc_inv: function (t, e, a) {
      ...
      return {
        lat:
          (2 * Math.atan(Math.pow(l / c, 1 / o)) - Math.PI / 2) * this.degRad,
        lng: (n + p / o) * this.degRad,
      };
    },
  }),
      ...
      this.defaultWidth * this.scale <= this.width
        ? ((t =
          ...
          (a =
            (this.width - this.defaultWidth * this.scale) / (2 * this.scale)))
        : ((t = 0),
          (a = (this.width - this.defaultWidth * this.scale) / this.scale)),
          ...
          'touchstart' == o.type && (r = 0),
            1 == d.length
              ? (1 == r &&
                  ((c = h.transX),
                  (p = h.transY),
                  (h.transX -= (a - d[0].pageX) / h.scale),
                  (h.transY -= (s - d[0].pageY) / h.scale),
                  h.applyTransform(),
                  h.tip.hide(),
      ...
      this.container.mousemove(function () {
        ...
        this.container.delegate(
          ...
          function (t) {
            ...
            'mouseover' == t.type
              ? (e.container.trigger(h, [s]),
                h.isDefaultPrevented() || i.setHovered(!0),
                e.tip.text(n),
