    ...
    (i.prototype = {
      ...
      constructHTMLCalendar: function (t, i) {
        ...
        (a +=
          ...
          '</div>'),
          (a += '<table className="table dtp-picker-days"><thead>');
