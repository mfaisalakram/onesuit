...
!(function () {
  ...
  var LobiboxBase = {
    ...
    _addCloseButton: function () {
      var me = this,
        closeBtn = $('<span className="btn-close">&times;</span>');
    ...
    var me = this,
      ...
      _createTabControl = function (tabPaneId) {
        ...
        return (
          $('<a></a>', { href: '#' + tabPaneId })
            .append(
              '<i className="tab-control-icon ' + me.$options.icon + '"></i>'
            )
            .appendTo($li),
          $li
        );
      ...
      _createNotify = function () {
        ...
        return (
          ...
          me.$options.title &&
            $body.prepend(
              '<div className="lobibox-notify-title">' +
                me.$options.title +
                '<div>'
            ),
