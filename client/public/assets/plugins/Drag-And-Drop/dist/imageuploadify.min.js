  ...
  $.fn.imageuploadify = function (opts) {
    ...
    this.each(function () {
      ...
      const readingFile = (id, file) => {
        ...
        let container = $(
          `<div className='imageuploadify-container'><button type='button'className='btn btn-danger bx bx-x'></button><div className='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>`
        );
