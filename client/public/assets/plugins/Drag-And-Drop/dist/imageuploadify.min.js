(function ($, window, document, undefined) {
  ...
  $.fn.imageuploadify = function (opts) {
    ...
    this.each(function () {
      ...
      let counter = 0;
      let dragbox = $(
        `<div className="imageuploadify well"><div className="imageuploadify-overlay"><i className="fa fa-picture-o"></i></div><div className="imageuploadify-images-list text-center"><i className="bx bxs-cloud-upload"></i><span class='imageuploadify-message'>Drag&Drop Your File(s)Here To Upload</span><button type="button"className="btn btn-default">or select file to upload</button></div></div>`
      );
